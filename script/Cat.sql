CREATE TABLE `dailygraph` (
  ...
  `ip` varchar(50) NOT NULL default '' COMMENT '报表来自于哪台cat-client机器ip, 空串表示合并同domain所有ip',
  `domain` varchar(50) NOT NULL DEFAULT '' COMMENT '报表处理的Domain信息',
  `period` datetime NOT NULL default CURRENT_TIMESTAMP  COMMENT '报表时间段',
  `type` int(11) unsigned NOT NULL DEFAULT 0 COMMENT '报表数据格式, 1/xml, 2/json, 3/csv, 默认3',
  `detail_content` mediumtext NOT NULL COMMENT '详细绘图内容',
  `summary_content` mediumtext NOT NULL COMMENT '概要绘图内容',
  `creation_date` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '报表创建时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `dailyreport` (
  ...
  `domain` varchar(50) NOT NULL DEFAULT '' COMMENT '报表处理的Domain信息',
  `period` datetime NOT NULL default CURRENT_TIMESTAMP  COMMENT '报表时间段',
  `type` int(11) unsigned NOT NULL DEFAULT 0 COMMENT '报表数据格式, 1/xml, 2/json, 默认1',
  `creation_date` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '报表创建时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `graph` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL DEFAULT '' COMMENT '报表名称',
  `ip` varchar(50) NOT NULL default '' COMMENT '报表来自于哪台cat-client机器ip, NULL表示合并同domain所有ip',
  `domain` varchar(50) NOT NULL DEFAULT '' COMMENT '报表处理的Domain信息',
  `period` datetime NOT NULL default CURRENT_TIMESTAMP  COMMENT '报表时间段',
  `type` int(11) unsigned NOT NULL DEFAULT 0 COMMENT '报表数据格式, 1/xml, 2/json, 3/csv, 默认3',
  `detail_content` mediumtext NOT NULL COMMENT '详细绘图内容',
...
CREATE TABLE `report` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `type` int(11) unsigned NOT NULL DEFAULT 0 COMMENT '报表类型, 1/xml, 9/binary 默认1',
  `name` varchar(20) NOT NULL DEFAULT '' COMMENT '报表名称',
...
CREATE TABLE `report_content` (
  `report_id` int(11) unsigned NOT NULL DEFAULT 0 COMMENT '报表ID',
...
CREATE TABLE `businessReport` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `type` int(11) unsigned NOT NULL DEFAULT 0 COMMENT '报表类型 报表数据格式, 1/Binary, 2/xml , 3/json',
  `name` varchar(20) NOT NULL DEFAULT '' COMMENT '报表名称',
  `ip` varchar(50) NOT NULL DEFAULT '' COMMENT '报表来自于哪台机器',
  `productLine` varchar(50) NOT NULL DEFAULT '' COMMENT '指标来源于哪个产品组',
  `period` timestamp NOT NULL COMMENT '报表时间段',
...
CREATE TABLE `task` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `producer`      varchar(20) NOT NULL DEFAULT '' COMMENT '任务创建者ip',
  `consumer`      varchar(20) NULL COMMENT '任务执行者ip',
  `failure_count` int(11) unsigned NOT NULL DEFAULT 0 COMMENT '任务失败次数',
  `report_name`   varchar(20) NOT NULL DEFAULT '' COMMENT '报表名称, transaction, problem...',
  `report_domain` varchar(50) NOT NULL DEFAULT '' COMMENT '报表处理的Domain信息',  
  `report_period` datetime NOT NULL default CURRENT_TIMESTAMP  COMMENT '报表时间',
  `status`        int(11) unsigned NOT NULL DEFAULT 0 COMMENT '执行状态: 1/todo, 2/doing, 3/done 4/failed',  
  `task_type`     int(11) unsigned NOT NULL DEFAULT 0 DEFAULT '1' COMMENT '0表示小时任务，1表示天任务',
  `creation_date` datetime NOT NULL default CURRENT_TIMESTAMP  COMMENT '任务创建时间',
...
CREATE TABLE `topologyGraph` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `ip` varchar(50) NOT NULL DEFAULT '' COMMENT '报表来自于哪台cat-client机器ip',
  `period` datetime NOT NULL default CURRENT_TIMESTAMP  COMMENT '报表时间段,精确到分钟',
  `type` int(11) unsigned NOT NULL DEFAULT 0 COMMENT '报表数据格式, 1/xml, 2/json, 3/binary',
  `content` longblob COMMENT '用于存放报表的具体内容',
  `creation_date` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '报表创建时间',
  PRIMARY KEY (`id`),
  KEY `period` (`period`)
...
CREATE TABLE `config` (
  ...
  `creation_date` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '配置创建时间',
  `modify_date` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '配置修改时间',
  PRIMARY KEY (`id`),
  KEY `name` (`name`)
...
CREATE TABLE `baseline` (
  ...
  `index_key` varchar(100) NOT NULL DEFAULT '',
  `report_period` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `data` blob,
  `creation_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `alteration` (
  ...
  `type` varchar(64) NOT NULL DEFAULT '' COMMENT '分类',
  ...
  `date` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '变更时间',
  `user` varchar(45) NOT NULL DEFAULT '' COMMENT '变更用户',
  ...
  `creation_date` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '数据库创建时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `alert` (
  ...
  `category` varchar(64) NOT NULL DEFAULT '' COMMENT '告警分类:network/business/system/exception -alert',
  `type` varchar(64) NOT NULL DEFAULT '' COMMENT '告警类型:error/warning',
  `content` longtext NOT NULL COMMENT '告警内容',
  `metric` varchar(128) NOT NULL DEFAULT '' COMMENT '告警指标',
  `creation_date` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '数据插入时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `operation` (
  ...
  `time` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '修改时间',
...
CREATE TABLE `app_command_data_1` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增长ID',
  `period` date NOT NULL default '0000-00-00' '时间',
  `minute_order` int(11) unsigned NOT NULL default 0 COMMENT '分钟',
  `city` int(11) unsigned NOT NULL default 0 COMMENT '城市',
  `operator` int(11) unsigned NOT NULL default 0 COMMENT '运营商',
  `network` int(11) unsigned NOT NULL default 0 COMMENT '网络类型',
  `app_version` int(11) unsigned NOT NULL default 0 COMMENT '版本',
  `connect_type` int(11) unsigned NOT NULL default 0 COMMENT '访问类型，是否长连接',
  `code` int(11) unsigned NOT NULL default 0 COMMENT '返回码',
  `platform` int(11) unsigned NOT NULL default 0 COMMENT '平台',
  `access_number` int(11) unsigned NOT NULL default 0 COMMENT '访问量',
  `response_sum_time` int(11) unsigned NOT NULL default 0 COMMENT '响应时间大小',
  `request_package` int(11) unsigned NOT NULL default 0 COMMENT '请求包大小',
  `response_package` int(11) unsigned NOT NULL default 0 COMMENT '响应包大小',
...
CREATE TABLE `app_speed_data_1` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增长ID',
  `period` date NOT NULL default '0000-00-00' COMMENT '时间',
  `minute_order` int(11) unsigned NOT NULL default 0 COMMENT '分钟',
  `city` int(11) unsigned NOT NULL default 0 COMMENT '城市',
  `operator` int(11) unsigned NOT NULL default 0 COMMENT '运营商',
  `network` int(11) unsigned NOT NULL default 0 COMMENT '网络类型',
  ...
  `platform` int(11) unsigned NOT NULL default 0 COMMENT '平台',
  `access_number` int(11) unsigned NOT NULL default 0 COMMENT '访问量',
  `slow_access_number` int(11) unsigned NOT NULL default 0 COMMENT '慢用户访问量',
  `response_sum_time` int(11) unsigned NOT NULL default 0 COMMENT '响应时间大小',
  `slow_response_sum_time` int(11) unsigned NOT NULL default 0 COMMENT '慢用户响应时间大小',
  `status` int(11) unsigned NOT NULL default 0 COMMENT '数据状态',
  `creation_date` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '数据插入时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `overload` (
  ...
  `report_type` int(11) unsigned NOT NULL DEFAULT 0 COMMENT '报告类型 1:hourly 2:daily 3:weekly 4:monthly',
  `report_size` double NOT NULL default 0 COMMENT '报告大小 单位MB',
...
CREATE TABLE `config_modification` (
  ...
  `action_name` varchar(64) NOT NULL DEFAULT '' COMMENT 'action名',
  `argument` longtext COMMENT '参数内容',
  `date` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '修改时间',
  `creation_date` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
